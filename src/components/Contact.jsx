    ...
    >
      ...
      >
        ...
        <div className='flex flex-col xl:flex-row items-center justify-center'>
          <div
            className='flex flex-col gap-8 text-[30px] my-6 md:my-4 xl:my-0 md:text-[38px] items-center xl:items-start text-[#c58000]'
          >
          ...
          <div
            className='flex md:h-[550px] h-[350px] md:w-[650px] xl:w-[550px] items-start justify-center mt-4'
          >
